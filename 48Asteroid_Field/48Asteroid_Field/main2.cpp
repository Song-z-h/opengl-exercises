...
int main()
{
	...
	// -------------------------
	Shader asteroidShader("10.3.instancing.vs", "10.3.instancing.fs");
	...
	for (unsigned int i = 0; i < amount; i++)
	{
		...
		// 1. translation: displace along circle with 'radius' in range [-offset, offset]  -2.5 to 2.5
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		memcpy(ptr, modelMatrices, amount * sizeof(glm::mat4));
